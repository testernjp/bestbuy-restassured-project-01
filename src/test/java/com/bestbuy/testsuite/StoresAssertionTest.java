...
public class StoresAssertionTest extends TestBase {
    ...
    // 2) Verify that the store of limit is equal to 10
    @Test
    public void test002() {
    ...
    // 3) Verify that the single ‘Name’ in the Array list (Inver Grove Heights)
    @Test
    public void test003() {
    ...
    // 4) Verify that the multiple ‘Names’ in the ArrayList (Roseville, Burnsville, Maplewood)
    @Test
    public void test004() {
